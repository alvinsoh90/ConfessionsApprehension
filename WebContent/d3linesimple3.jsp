...
<script>
	...
	var valueline = d3.svg.line() 
		...
		.y(function(d) { return y(d.numberofposts); });
	...
	var axisData = [
	                ...
	                {"datetime": "2013-11-30 23:59:59",    "numberofposts": 5},
	            	];
	x.domain(d3.extent(axisData, function(d) { return parseDate(d.datetime); }));
	y.domain([0, d3.max(axisData, function(d) { return d.numberofposts; })]);
		...
		$.ajax({
			...
			success: function (allData) {
				...
				dots = svg.selectAll("dot")
					...
					.attr("cy", function(d) { return y(d.numberofposts); })
